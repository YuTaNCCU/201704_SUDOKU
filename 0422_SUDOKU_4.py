...
#3普通302005690040009603005000800019008070300000000507030061000800020080960070065700309
#4某許000100000006370048000050009079000015600705000530000760401030000860024500300008000
...
def array(i,j):
    a=[]
    b=[]
    for j_j in range(0,j):
        a.append(1)
    for i_i in range(0,i):
        b.append(a.copy())
    return b
Array_1=array(9,9)
...
def input_1():
    ...
    for i in range(0,9):
        for j in range(0,9):
            Array_1[i][j]=int(inputText[9*i+j])
    #print(inputText)
    print('讀取Array_1=\n',Array_1)
